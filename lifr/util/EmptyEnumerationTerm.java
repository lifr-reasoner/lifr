 ...
 * @author  sinner
 */
public final class EmptyEnumerationTerm implements Enumeration<Term>{
    
    /** Creates a new instance of EmptyEnumerator */
    private EmptyEnumerationTerm() {
    }
     ...
     */    
    public static final EmptyEnumerationTerm INSTANCE = new EmptyEnumerationTerm();
