 ...
 * @author  sinner
 */
public final class EmptyEnumerationPredicate implements Enumeration<Predicate>{
    
    /** Creates a new instance of EmptyEnumerator */
    private EmptyEnumerationPredicate() {
    }
     ...
     */    
    public static final EmptyEnumerationPredicate INSTANCE = new EmptyEnumerationPredicate();
