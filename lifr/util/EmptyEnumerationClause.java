 ...
 * @author  sinner
 */
public final class EmptyEnumerationClause implements Enumeration<Clause>{
    
    /** Creates a new instance of EmptyEnumerator */
    private EmptyEnumerationClause() {
    }
     ...
     */    
    public static final EmptyEnumerationClause INSTANCE = new EmptyEnumerationClause();
